...
import estrada.leon.rafael.readwatch.administrador.adapter.MateriasAdapterAdmin;
...
public class ElegirMateriaAdm extends Fragment implements  MateriasAdapter.OnMateriaListener,
    ...
    private MateriasAdapterAdmin materiasAdapter;
    ...
    public ElegirMateriaAdm() {
        // Required empty public constructor
    }

    public static ElegirMateriaAdm newInstance(String param1, String param2) {
        ElegirMateriaAdm fragment = new ElegirMateriaAdm();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_elegir_materia_adm, container, false);
